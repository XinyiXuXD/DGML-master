...
def Give(opt, datapath):
    image_sourcepath  = opt.data_path+'/images'
    training_files = pd.read_table(opt.data_path+'/Info_Files/Ebay_train.txt', header=0, delimiter=' ')
    test_files     = pd.read_table(opt.data_path+'/Info_Files/Ebay_test.txt', header=0, delimiter=' ')
